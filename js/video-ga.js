...
myPlayer.ready(function() {
    ...
    var firstEvent = function() {
        ...
        ga('send', 'event', 'video', 'loaded', videoName, whereYouAt, true);
    };
    ...
    var timeEvent = function() {
        ...
        if (percentThis >= 5 && !time5) {
            ...
            ga('send', 'event', 'video', '5%', videoName, whereYouAt, true);
            time5 = true;
        }*/
        ...
        if (Math.abs(seekStart - seekEnd) > 1) {
            ...
            ga('send', 'event', 'video', 'seek start', videoName, seekStart, true);
            //console.log("category:video|action:seek end|label:"+videoName+"|value:"+seekEnd);
            ga('send', 'event', 'video', 'seek end', videoName, seekEnd, true);
        }
    };
    ...
    var playEvent = function() {
        ...
        if (isUserSeeking && !isVideoPlaying) {
            ...
            ga('send', 'event', 'video', 'play after seek', videoName, whereYouAt, true);
            ...
            ga('send', 'event', 'video', 'play', videoName, whereYouAt, true);
        } else if (whereYouAt == 0) {
            //console.log("category:video|action:autoplay|label:"+videoName+"|value:"+whereYouAt);
            ga('send', 'event', 'video', 'autoplay', videoName, whereYouAt, true);
        }
    ...
    var pauseEvent = function() {
        ...
        if (!isUserSeeking && whereYouAt != howLongIsThis) {
            ...
            ga('send', 'event', 'video', 'pause', videoName, whereYouAt, true);
        }
    };
    ...
    var endEvent = function() {
        ...
        ga('send', 'event', 'video', '100%', videoName, whereYouAt, true);
    };
    ...
    var errorEvent = function() {
        ...
        ga('send', 'event', 'video', 'error', videoName, whereYouAt, true);
    };
